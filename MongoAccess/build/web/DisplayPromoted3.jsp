    ...
    <div class="col-sm-1"></div>
        ...
        <div class="row">
			...
			<li><a href="#" onClick="sizeSelect10()">10</a></li>
                    ...
                    <button type="submit" class="btn-sm btn-primary" name="promote">Promote</button>
                    <button type="submit" class="btn-sm btn-primary" name="demote" formaction="Demote3.jsp">Demote</button> 
                    <button type="button" class="btn-sm btn-primary glyphicon glyphicon-refresh" onClick="window.location.reload();"></button>   
                    <button type="button" class="btn-sm btn-primary" onclick="window.location = 'v5.jsp';">View All</button>					
