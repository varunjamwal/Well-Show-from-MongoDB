        ...
        <div class="row">
          <form method="post"> 
			...
			<li><a href="#" onClick="sizeSelect10()">10</a></li>
                        ...
                        <button type="submit" class="btn-sm btn-primary" name="promote" formaction="stage2.jsp">Promote</button>
                        <button type="submit" class="btn-sm btn-primary" name="demote" formaction="Demote.jsp">Demote</button> 
                    <button type="button" class="btn-sm btn-primary glyphicon glyphicon-refresh" onClick="window.location.reload();"></button>   
                    <button type="button" class="btn-sm btn-primary" onclick="window.location = 'v2.jsp';">View All</button>					
